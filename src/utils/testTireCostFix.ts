...
export const testTireCostFix = async () => {
  ...
  if (sucessos === total) {
    console.log(
      "✅ [TestTireCostFix] TESTE PASSOU! Todos os produtos foram inicializados corretamente."
    );
  } else {
    console.log(
      "❌ [TestTireCostFix] TESTE FALHOU! Alguns produtos não foram inicializados."
    );
  }
