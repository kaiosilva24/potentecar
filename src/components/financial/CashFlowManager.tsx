...
const CashFlowManager = ({
    ...
    const resaleProductsAvailable = resaleProducts
      ...
      .map((product) => {
        ...
        return {
          ...
          suggestedPrice:
            ((stockItem?.total_value || 0) / (stockItem?.quantity || 1)) * 1.2, // Margem de 20%
        };
      });
  ...
  const addProductToCart = () => {
    ...
    if (quantity > selectedProduct.availableQuantity) {
      alert(
        `Estoque insuficiente. Disponível: ${selectedProduct.availableQuantity}`
      );
      return;
    }
  ...
  const extractProductInfoFromSale = (description: string) => {
    ...
    if (productIdMatch && quantityMatch) {
      ...
      console.log(
        "✅ [FINANCIAL DELETE] Produto extraído com sucesso:",
        result
      );
      return result;
    }
    ...
    console.log(
      "❌ [FINANCIAL DELETE] Não foi possível extrair informações do produto"
    );
    return null;
  };
  ...
  const handleDeleteTransaction = async (entry: CashFlowEntry) => {
    console.log("🔥 [FINANCIAL DELETE] Iniciando exclusão:", {
      entryId: entry.id,
    ...
    if (confirm(confirmMessage)) {
      ...
      try {
        console.log(
          "🔥 [FINANCIAL DELETE] Usuário confirmou, iniciando processo..."
        );
        console.log(
          "🔥 [FINANCIAL DELETE] Descrição da transação:",
          entry.description
        );
        ...
        if (isSaleTransaction && entry.description) {
          ...
          console.log("🔥 [FINANCIAL DELETE] Tipo de produto:", {
            isRawMaterial,
            isResaleProduct,
            isFinalProduct,
          });
          ...
          if (productInfo) {
            console.log(
              "🔥 [FINANCIAL DELETE] Produto ID para buscar:",
              productInfo.productId
            );
            console.log(
              "🔥 [FINANCIAL DELETE] Quantidade para retornar:",
            ...
            try {
              if (isRawMaterial) {
                console.log(
                  "🔥 [FINANCIAL DELETE] Processando matéria-prima..."
                );
                ...
                const stockItem = stockItems.find((item) => {
                  ...
                  console.log(
                    "🔥 [FINANCIAL DELETE] Comparando item matéria-prima:",
                    {
                      itemId: item.id,
                ...
                console.log(
                  "🔥 [FINANCIAL DELETE] Item de estoque encontrado (matéria-prima):",
                  stockItem
                );
                ...
                if (stockItem) {
                  ...
                  console.log(
                    "🔥 [FINANCIAL DELETE] Atualizando estoque matéria-prima:",
                    {
                  ...
                  console.log(
                    "✅✅✅ [FINANCIAL DELETE] ESTOQUE DE MATÉRIA-PRIMA RESTAURADO COM SUCESSO! ✅✅✅"
                  );
                  stockRestored = true;
                  ...
                  console.log(
                    "📡 [FINANCIAL DELETE] Evento de sincronização disparado para matéria-prima"
                  );
                } else {
                  console.error(
                    "❌ [FINANCIAL DELETE] Item de estoque não encontrado para matéria-prima:",
                    productInfo.productId
                  );
                  console.log(
                    "🔥 [FINANCIAL DELETE] Matérias-primas disponíveis:",
                    stockItems
                ...
                console.log(
                  "🔥 [FINANCIAL DELETE] Processando produto de revenda..."
                );
                ...
                console.log(
                  "🔥 [FINANCIAL DELETE] Item de estoque encontrado (revenda):",
                  stockItem
                );
                ...
                if (stockItem) {
                  ...
                  console.log(
                    "🔥 [FINANCIAL DELETE] Atualizando estoque revenda:",
                    {
                      stockItemId: stockItem.id,
                      previousQuantity: stockItem.quantity,
                      returnedQuantity: productInfo.quantity,
                  ...
                  console.log(
                    "✅ [FINANCIAL DELETE] Estoque de produto de revenda restaurado com sucesso!"
                  );
                  stockRestored = true;
                } else {
                  console.error(
                    "❌ [FINANCIAL DELETE] Item de estoque não encontrado para produto de revenda:",
                    productInfo.productId
                  );
                  console.log(
                    "🔥 [FINANCIAL DELETE] Itens disponíveis no estoque:",
                    stockItems.map((item) => ({
                      id: item.item_id,
                      name: item.item_name,
                      type: item.item_type,
                ...
                console.log(
                  "🔥 [FINANCIAL DELETE] Processando produto final..."
                );
                ...
                console.log(
                  "🔥 [FINANCIAL DELETE] Item de estoque encontrado (final):",
                  stockItem
                );
                ...
                if (stockItem) {
                  ...
                  console.log(
                    "🔥 [FINANCIAL DELETE] Atualizando estoque final:",
                    {
                      stockItemId: stockItem.id,
                      previousQuantity: stockItem.quantity,
                      returnedQuantity: productInfo.quantity,
                  ...
                  console.log(
                    "✅ [FINANCIAL DELETE] Estoque de produto final restaurado com sucesso!"
                  );
                  stockRestored = true;
                } else {
                  console.error(
                    "❌ [FINANCIAL DELETE] Produto final não encontrado no estoque:",
                    productInfo.productId
                  );
                  console.log(
                    "🔥 [FINANCIAL DELETE] Produtos finais disponíveis:",
                    stockItems
              ...
              console.error(
                "❌ [FINANCIAL DELETE] Erro ao restaurar estoque:",
                stockError
              );
              alert(
            ...
            console.error(
              "❌ [FINANCIAL DELETE] Não foi possível extrair informações do produto da venda"
            );
            console.log(
              "🔥 [FINANCIAL DELETE] Descrição completa:",
              entry.description
            );
          }
        } else {
          console.log(
            "🔥 [FINANCIAL DELETE] Não é uma venda ou sem descrição, prosseguindo com exclusão normal"
          );
        ...
        console.log(
          "🔥 [FINANCIAL DELETE] Deletando entrada do fluxo de caixa..."
        );
        try {
          ...
          console.log(
            "✅ [FINANCIAL DELETE] Entrada do fluxo de caixa deletada com sucesso!"
          );
        } catch (deleteError) {
          console.error(
            "❌ [FINANCIAL DELETE] Erro específico ao deletar do fluxo de caixa:",
            deleteError
          );
          ...
          if (stockRestored && isSaleTransaction) {
            ...
            alert(
              `Erro ao excluir a transação: ${deleteError.message || deleteError}\n\nNenhuma alteração foi feita.`
            );
          }
          return;
        }
        ...
        console.error(
          "❌ [FINANCIAL DELETE] Erro geral ao excluir transação:",
          error
        );
        alert(
          `Erro ao excluir a transação: ${error.message || error}\n\nVerifique o console para mais detalhes.`
        );
      }
    }
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <SelectContent className="bg-factory-800 border-tire-600/30">
                      {getCurrentCategoryData()
                        ...
                        .sort((a: any, b: any) => {
                          ...
                          const nameA =
                            category === "debts" ? a.description : a.name;
                          const nameB =
                            category === "debts" ? b.description : b.name;
              ...
              {type === "income" && isMultiProductMode && (
                <div className="space-y-4 p-4 bg-factory-700/30 rounded-lg border border-tire-600/20">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label className="text-tire-300 text-sm font-medium">
                        Produto
                      </Label>
                      <Select
                  ...
                  {productCart.length > 0 && (
                    <div className="space-y-2">
                      <div className="flex items-center justify-between">
                        <span className="text-tire-200 font-medium text-sm">
                          Carrinho ({productCart.length} produtos)
                        </span>
                        <Button
                          type="button"
                          variant="ghost"
              ...
              {type === "income" && isMultiProductMode ? (
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-neon-green to-neon-blue hover:from-neon-blue hover:to-neon-green text-white"
                  disabled={
                    isLoading || !referenceName || productCart.length === 0
                  }
                >
            ...
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {filteredEntries.length === 0 ? (
                ...
                (() => {
                  ...
                  const extractPaymentMethodFromSale = (
                    description: string
                  ) => {
                  ...
                  const groupSalesByTransaction = (entries: any[]) => {
                    ...
                    salesEntries.forEach((sale) => {
                      const cleanClientName = (
                        ...
                        .replace(/\s+-\s+.*$/, "");
                      const paymentMethod = extractPaymentMethodFromSale(
                        sale.description || ""
                      );
                  ...
                  const salesEntries = filteredEntries.filter(
                    (entry) =>
                      entry.type === "income" &&
                      entry.description &&
                      entry.description.includes("ID_Produto:")
                          ...
                          <div className="p-4 bg-neon-green/10 rounded-lg border border-neon-green/30">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <div className="text-right">
                                ...
                                <p className="text-tire-300 text-sm">
                                  {item.sales.length} tipo
                                  {item.sales.length > 1 ? "s" : ""} de produto
                                  {item.sales.length > 1 ? "s" : ""}
                                </p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                              <Button
                                ...
                                size="sm"
                                onClick={() =>
                                  toggleTransactionExpansion(item.key)
                                }
                            ...
                            <div className="space-y-1 ml-8">
                              {item.sales.map((sale) => {
                                ...
                                return (
                                  <div
                                    key={sale.id}
                                    className="flex items-center justify-between p-3 bg-factory-700/20 rounded border border-tire-600/20"
                                  >
                                    <div className="flex items-center gap-2">
                                      <span className="text-neon-green font-bold text-sm">
