...
const FloatingHistoryControls: React.FC<FloatingHistoryControlsProps> = ({
  ...
  const { canUndo, canRedo, totalEntries, updateStatus } = useChangeHistoryStatus();
            ...
            <div className="flex flex-col space-y-2 mb-2">
              ...
              <Tooltip>
                ...
                <TooltipContent side="left">
                  <p>{canUndo ? 'Desfazer última alteração' : 'Nenhuma alteração para desfazer'}</p>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                ...
                <TooltipContent side="left">
                  <p>{canRedo ? 'Refazer próxima alteração' : 'Nenhuma alteração para refazer'}</p>
                </TooltipContent>
              </Tooltip>
            </div>
          )}
