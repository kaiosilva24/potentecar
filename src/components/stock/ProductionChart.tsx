    ...
    const chartData = Array.from(groupedData.values())
      .sort((a, b) => {
        ...
        switch (sortBy) {
          ...
          case "averagePerDay":
            const avgA =
              a.productionDays > 0 ? a.totalProduced / a.productionDays : 0;
            const avgB =
              b.productionDays > 0 ? b.totalProduced / b.productionDays : 0;
        ...
        <div className="bg-factory-800/95 border border-tire-600/50 rounded-lg p-4 shadow-lg backdrop-blur-sm min-w-[280px]">
          <div className="space-y-3">
            ...
            <div className="border-b border-tire-600/30 pb-2">
              ...
              <div className="text-xs text-tire-400 mt-1">Produto Final</div>
            </div>
            ...
            <div className="pt-2 border-t border-tire-600/30">
              <div className="space-y-2">
                {/* Perdas de produção */}
                <div className="flex items-center justify-between">
                  <span className="text-tire-300 text-sm">
                    Perdas Produção:
                  </span>
