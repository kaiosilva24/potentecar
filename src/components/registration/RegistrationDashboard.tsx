...
const RegistrationDashboard = ({
  ...
  const handleEditMaterial = async (
    ...
    console.log(`✏️ [RegistrationDashboard] Editando matéria-prima:`, {
      id: materialId,
      updatedData,
    });
    ...
    try {
      ...
      console.log(
        `✅ [RegistrationDashboard] Matéria-prima editada com sucesso`
      );
    } catch (error) {
      console.error(
        `❌ [RegistrationDashboard] Erro ao editar matéria-prima:`,
        error
      );
    }
  };
