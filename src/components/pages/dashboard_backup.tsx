...
const EmpresarialProfitChart = ({
  ...
  const loadBusinessProfitChartData = async () => {
    try {
      ...
      console.log(
        "📊 [EmpresarialProfitChart] Chamando loadBaselineHistory..."
      );
      ...
      try {
        ...
        console.log(
          "✅ [EmpresarialProfitChart] loadBaselineHistory executado com sucesso"
        );
      } catch (historyError) {
        console.error(
          "❌ [EmpresarialProfitChart] Erro específico em loadBaselineHistory:",
          historyError
        );
      ...
      if (!historicalData || historicalData.length === 0) {
        console.log(
          "📊 [EmpresarialProfitChart] Sem histórico, usando dados atuais"
        );
        ...
        for (let i = days - 1; i >= 0; i--) {
          ...
          chartData.push({
            date: dateStr,
            businessProfit:
              isToday && businessProfit !== null ? businessProfit : 0,
            businessValue:
              isToday && empresarialValue !== null ? empresarialValue : 0,
            baseline:
              isToday && businessBaseline !== null ? businessBaseline : null,
          });
        }
      } else {
      ...
      if (error && typeof error === "object") {
        ...
        console.error(
          "❌ [EmpresarialProfitChart] Erro primitivo:",
          typeof error,
          error
        );
      }
  ...
  const loadCurrentBusinessProfit = async () => {
    try {
      ...
      console.log(
        "📊 [EmpresarialProfitChart] Iniciando carregamento do lucro empresarial..."
      );
      ...
      console.log(
        "✅ [EmpresarialProfitChart] Lucro empresarial carregado com sucesso"
      );
    } catch (error) {
      console.error(
        "❌ [EmpresarialProfitChart] Erro ao carregar lucro empresarial:",
        error
      );
      console.error("❌ [EmpresarialProfitChart] Stack trace:", error.stack);
    } finally {
  ...
  const saveCurrentProfitToHistory = async () => {
    if (empresarialValue !== null && businessBaseline !== null) {
      try {
        ...
        console.error(
          "❌ [EmpresarialProfitChart] Erro ao salvar histórico:",
          error
        );
      }
    }
