...
const MainDashboard = ({ isLoading = false }: { isLoading?: boolean }) => {
  ...
  useEffect(() => {
    if (showSecondaryData && 
      ...
      console.log('✅ [Dashboard] Fase 2 completa - dados secundários carregados');
  ...
  }, [showSecondaryData, defectiveTireSalesLoading, productionLoading, materialsLoading, productsLoading, resaleProductsLoading, stockItemsLoading]);
  ...
  const isSecondaryDataLoading = showSecondaryData && (
    defectiveTireSalesLoading ||
    productionLoading ||
    materialsLoading ||
    productsLoading ||
  ...
  const isTertiaryDataLoading = loadTertiaryData && (
    fixedCostsLoading ||
  ...
  const isChartsLoading = isCriticalDataLoading || isSecondaryDataLoading || !chartsInitialized;
        ...
        <Card className="bg-factory-800/50 border-tire-600/30">
          ...
          <CardContent className="min-h-[400px] w-full">
            <div className="min-h-[350px] w-full">
              {isSecondaryDataLoading || !materials || !products || !stockItems ? (
                <div className="flex items-center justify-center h-[350px]">
